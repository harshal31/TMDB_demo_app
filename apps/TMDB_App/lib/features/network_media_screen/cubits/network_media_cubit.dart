...
class NetworkMediaCubit extends Cubit<AdvanceFilterPaginationState> {
  ...
  void fetchKeywordMedias(String networkId, int page) async {
    ...
    final results = await tvAdvanceFilterUseCase.advanceTvFilter(
      withNetworks: int.parse(networkId),
      page: page,
    );
