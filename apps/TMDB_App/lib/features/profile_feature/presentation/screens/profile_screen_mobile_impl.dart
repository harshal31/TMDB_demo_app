...
class ProfileScreenMobileImpl extends StatelessWidget {
  @override
                        ...
                        AnimatedOpacity(
                          ...
                          child: TmdbHorizontalList(
                            imageUrls: favState.latestResults?.latestData
                                ...
                                [],
                            onItemClick: (index) {
                              final media = state.accountDetailData.watchList?.latestData?[index] ??
                                  favState.latestResults?.latestData?[index];
                              CommonNavigation.redirectToDetailScreen(
                                context,
                                mediaType: favState.pos == 0 ? RouteParam.movie : RouteParam.tv,
                                mediaId: media?.id.toString(),
