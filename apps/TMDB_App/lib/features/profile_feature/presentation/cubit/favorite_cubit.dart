...
class FavoriteCubit extends Cubit<AccountState> {
  final AccountMediaUseCase _useCase;

  FavoriteCubit(this._useCase) : super(AccountState.initial());
  ...
  void fetchAccountMedia({
    ...
    final result = await _useCase.fetchAccountMedia(actId, ApiKey.favorite, mediaType, sessionId);
