...
class WatchListCubit extends Cubit<AccountState> {
  final AccountMediaUseCase _useCase;

  WatchListCubit(this._useCase) : super(AccountState.initial());
  ...
  void fetchAccountMedia({
    ...
    final result = await _useCase.fetchAccountMedia(actId, ApiKey.watchlist, mediaType, sessionId);
