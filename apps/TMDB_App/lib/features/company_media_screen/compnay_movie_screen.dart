...
import 'package:tmdb_app/features/company_media_screen/screens/company_movie_screen_impl.dart';
...
class CompanyMoviesScreen extends StatelessWidget {
  final String companyId;
  final String companyName;

  const CompanyMoviesScreen({
    super.key,
    ...
    return MultiBlocProvider(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: CompanyMovieScreenMovieImpl(
